...
function enterCustomization() {
    ...
    fetch('https://gta_gameroo/customizeStart', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    }).then(nuiResp).then(function(data) {
...
function setCamera(preset) {
    fetch('https://gta_gameroo/setCameraPreset', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        ...
        if (isSelected) {
            ...
            (function(hash) {
                btn.addEventListener('click', function(e) {
                    e.stopPropagation();
                    fetch('https://gta_gameroo/selectModel', {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ modelHash: hash })
                    });
            ...
            (function(hash) {
                btn.addEventListener('click', function(e) {
                    ...
                    btn.disabled = true;
                    purchaseConfirmHash = null;
                    fetch('https://gta_gameroo/purchaseModel', {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ modelHash: hash })
                    });
    ...
    for (var i = 0; i < 20; i++) {
        (function(idx) {
            ...
            slider.addEventListener('input', function() {
                ...
                fetch('https://gta_gameroo/changeFaceFeature', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
...
function sendHeadBlend(hb) {
    fetch('https://gta_gameroo/changeHeadBlend', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
...
function sendHair(hair) {
    fetch('https://gta_gameroo/changeHair', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
function sendOverlay(overlayId, ov) {
    fetch('https://gta_gameroo/changeHeadOverlay', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
            overlayId: overlayId,
    ...
    for (var i = 0; i < 12; i++) {
        ...
        (function(compId) {
            ...
            var pn = createPrevNext(cur.drawable, maxDraw, function(val) {
                cur.drawable = val;
                cur.texture = 0;
                fetch('https://gta_gameroo/changeComponent', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
    ...
    propsSettings.forEach(function(ps, idx) {
        ...
        (function(pId, cur, maxD) {
            ...
            var pn = createPrevNext(cur.drawable, maxD, function(val) {
                cur.drawable = val;
                cur.texture = 0;
                fetch('https://gta_gameroo/changeProp', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
    ...
    for (var i = 0; i < eyeColorNames.length; i++) {
        (function(idx) {
            ...
            btn.addEventListener('click', function() {
                ...
                fetch('https://gta_gameroo/changeEyeColor', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
...
document.getElementById('rotateLeft').addEventListener('click', function() {
    fetch('https://gta_gameroo/rotatePed', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
