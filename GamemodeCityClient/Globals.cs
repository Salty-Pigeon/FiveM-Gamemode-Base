...
namespace GamemodeCityClient {
    public class Globals : BaseScript {
        ...
        public static Dictionary<uint, Dictionary<string, dynamic>> Weapons = new Dictionary<uint, Dictionary<string, dynamic>>() {
            ...
            { 1432025498, new Dictionary<string, dynamic>(){ { "ModelHashKey", "w_sg_pumpshotgunmk2" }, { "Description", "Only one thing pumps more action than a pump action: 'ch out, the recoil is almost as deadly as the shot." }, { "AmmoType", "AMMO_SHOTGUN" }, { "Group", "GROUP_SHOTGUN" }, { "DefaultClipSize", "8" }, { "NameGXT", "WT_SG_PMP2" }, { "Name", "Pump Shotgun Mk II"}, { "DLC", "mpchristmas2017" }, { "DescriptionGXT", "WTD_SG_PMP2" }, { "HashKey", "WEAPON_PUMPSHOTGUN_MK2" }, } },
